...
docker run --rm --entrypoint=deploy-win.bat -v "%CD%\container-scripts":C:/container-scripts -w /container-scripts -e PULL_ID -e APSIM_SITE_CREDS -e APSIM_CERT -e APSIM_CERT_PWD -e APSIM_SITE_CREDS %container%
