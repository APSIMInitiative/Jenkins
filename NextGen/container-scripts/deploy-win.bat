...
rem     Models -> C:\container-scripts\ApsimX\bin\Release\net6.0\win-x64\Models.dll
rem     Models -> C:\container-scripts\ApsimX\bin\Release\net6.0\Models.dll
rem     Models -> C:\container-scripts\ApsimX\bin\Release\net6.0\win-x64\publish\Models.dll
rem This can lead to an incorrect  publish\models.deps.json. taken from net6.0 directory rather than from netcoreapp3.1\win-x64 directory
rem bug: https://github.com/APSIMInitiative/ApsimX/issues/7829
dotnet publish -c Release -f net6.0 -r win-x64 -m:1 --no-self-contained "%apsimx%\ApsimX.sln"
if errorlevel 1 exit /b 1
